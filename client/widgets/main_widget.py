...
from widgets.car_control_widget import CarControlWidget
...
class MainWidget(QWidget):
    ...
    class MainWidgetLayout(QGridLayout):
        def __init__(self, services, channel):
            ...
            self.addWidget(CarControlWidget(services, channel), 2, 0)

    def __init__(self, services, channel):
        super().__init__()
        self.setWindowTitle('Freenove Three-wheeled Smart Car Kit for Raspberry Pi')
        self.resize(1280, 720)
        self.setLayout(MainWidget.MainWidgetLayout(services, channel))
